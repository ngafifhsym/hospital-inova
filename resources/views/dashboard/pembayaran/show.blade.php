        ...
        <div class="p-2">
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name')
                    is-invalid
                @enderror" id="name" value="{{ old('name', $pegawai->name) }}" readonly>
            </div>
            @error('name')
        ...
        <div class="p-2">
            <div class="mb-3">
                ...
                <input type="text" name="jabatan" class="form-control @error('jabatan')
                    is-invalid
                @enderror" id="jabatan" value="{{ old('jabatan', $pegawai->jabatan) }}" readonly>
            </div>
            @error('jabatan')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="p-2">
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control @error('email')
                    is-invalid
                @enderror" id="email" aria-describedby="emailHelp" value="{{ old('email', $pegawai->email) }}" readonly>
            </div>
            @error('email')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="p-2">
            <div class="mb-3">
                ...
                <input type="text" name="nip" class="form-control @error('nip')
                    is-invalid
                @enderror" id="nip" value="{{ old('nip', $pegawai->nip) }}" readonly>
            </div>
            @error('nip')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <div class="p-2">
            <div class="mb-3">
                ...
                <input type="text" name="nohp" class="form-control @error('nohp')
                    is-invalid
                @enderror" id="nohp" value="{{ old('nohp', $pegawai->nohp) }}" readonly>
            </div>
            @error('nohp')
            <div class="invalid-feedback">
                {{ $message }}
